...
|:---:|:---:|:---:|
| ![4 obstacles](positional_augmentation/gen_4obs.gif) | ![5 obstacles](positional_augmentation/gen_5obs.gif) | ![6 obstacles](positional_augmentation/gen_6obs.gif) |
...
|:---:|:---:|:---:|
| ![expanding](dynamic_obstacles/expanding.gif) | ![shrinking](dynamic_obstacles/shrinking.gif) | ![expanding + rotating](dynamic_obstacles/expanding_rotating.gif) |
...
|:---:|:---:|:---:|
| ![translation](moving_obstacles/dynamic_translate.gif) | ![rotation](moving_obstacles/dynamic_rotate.gif) | ![translation + rotation](moving_obstacles/dynamic_transrotate.gif) |
...
![baselines](results/fig_baselines_grouped.png)
...
![novel shape](results/fig_novel_shape.png)
...
![system pipeline](architecture/system_pipeline.png)
...
![composite barrier](architecture/composite_barrier.png)
...
![online controller](architecture/online_controller.png)
...
![vector field](final_vector_field.png)
...
![learned CBF](final_learned_cbf.png)
...
|:---:|:---:|
| ![training losses](losses_from_training/full_training_losses.png) | ![barrier training](losses_from_training/barrier_training.png) |
